...
let showCart=()=>{
  if(cartGet){
    ...
    if(cartGet.length==1 ? divCountCart.textContent = "(" +" "+ x + " "+"item)": divCountCart.textContent = "("+ x + " "+"items)");
...
/////Avoid repeat aler message
  ...
  fieldsValidity = [validateFirstName, validateLastName, validateAddress, validateCity, validateEmail],
...
for (let i = 0; i < fields.length; i++) {
  ...
  console.log("🚀 ~ file: cart.js ~ line 205 ~ formValidation ~ firstNameId", fields.firstNameId)
}
return returnField;
